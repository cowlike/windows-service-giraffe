...
module Views =
    ...
    let layout (content: XmlNode list) =
        html [] [
            head [] [
                title []  [ encodedText "GiraffeService" ]
...
let configureApp (app : IApplicationBuilder) =
    ...
    (match env.EnvironmentName.ToLowerInvariant() with
    | "dev" -> app.UseDeveloperExceptionPage()
